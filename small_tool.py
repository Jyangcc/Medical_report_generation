...
dir_path = 'preprocessed_images/'

# List of child directories to process
child_dir = ['20230721_1st', '20230728_2nd', '20230804_3rd']

file_name_list = ['I0000000.npy', 'I0000001.npy','I0000002.npy', 'I0000003.npy']

not_full_files = []
full_files = []

print("=== Preprocessing Check: Verifying Complete Image Sets ===")
...
with open('docs/full_files.txt', 'w') as f:
